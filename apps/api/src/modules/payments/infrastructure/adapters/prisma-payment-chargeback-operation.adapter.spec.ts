import type { ProcessChargebackInput } from '../../application/use-cases/process-chargeback.use-case';
import { PrismaPaymentChargebackOperationAdapter as ProcessChargebackUseCase } from './prisma-payment-chargeback-operation.adapter';
