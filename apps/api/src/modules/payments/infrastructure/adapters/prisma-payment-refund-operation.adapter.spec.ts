import { PrismaPaymentRefundOperationAdapter as ProcessRefundUseCase } from './prisma-payment-refund-operation.adapter';
import {
...
describe('ProcessRefundUseCase', () => {
  ...
  it('returns REFUNDED result on success', async () => {
    ...
    const uc = new ProcessRefundUseCase(gateway, prisma, makeFinancialRecord(), mockLogger);
