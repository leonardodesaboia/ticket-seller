...
Inconsistência ai/ vs .ai/: investigar e consolidar em tarefa futura
...
TASK-004 — API Bootstrap, TASK-005 — Infraestrutura local, TASK-006 — Marketplace Web Bootstrap (execução paralela)
